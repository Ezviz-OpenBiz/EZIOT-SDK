 ...
 *  - ez_errno_fail : in case of control socket error while sending
 */
 ...
 *
 * @return
 *  - ez_errno_succ    : on successfully receiving, parsing and responding to a request
 *  - ez_errno_fail  : in case of failure in any of the stages of processing
 */
    ez_err_e httpd_sess_process(struct httpd_data *hd, int clifd);
 ...
 *
 * @return
 *  - ez_errno_succ    : if session closure initiated successfully
 ...
 *
 * @return
 *  - ez_errno_succ    : if handler found and executed successfully
 *  - ez_errno_fail  : otherwise
 */
 ...
 *
 * @return
 *  - ez_errno_succ    : if request packet is valid
 *  - ez_errno_fail  : otherwise
 */
 ...
 *
 * @return
 *  - ez_errno_succ    : if request packet deleted and resources cleaned.
 *  - ez_errno_fail  : otherwise.
 */
