 ...
 * @return status
 */
    typedef ez_err_e (*httpd_open_func_t)(httpd_handle_t hd, int sockfd);
 ...
 */
     ...
     */
        ez_err_e (*handler)(httpd_req_t *r);
 ...
 * @code{c}
 *
 * ez_err_e my_uri_handler(httpd_req_t* req)
 * {
 ...
 *  - ez_errno_httpd_result_trunc : Value string truncated
 */
    ez_err_e httpd_query_key_value(const char *qry, const char *key, char *val, size_t val_size);
 ...
 *  - ez_errno_param_invalid : Null arguments
 */
    ez_err_e httpd_sess_trigger_close(httpd_handle_t handle, int sockfd);
 ...
 *  - ez_errno_param_invalid : Null arguments
 */
    ez_err_e httpd_sess_update_lru_counter(httpd_handle_t handle, int sockfd);
